DESCRIPCIONES_AGRUPADORES = {

    "Estudiantes":
        "Indicadores relacionados con el desempeño y resultados de los estudiantes.",
    ...
    "Sostenibilidad":
        "Indicadores relacionados con sostenibilidad y gestión institucional.",
}