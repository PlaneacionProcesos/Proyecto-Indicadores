...
def generar_tarjetas_contexto_investigacion(datos_seccion, indicador_seleccionado=None):
    """
...
def registrar_callback_investigacion(app):
    ...
    # ==========================================================================
    # Callback Unificado de Alto Rendimiento (Tabla + Tarjetas de Investigación)
    # ==========================================================================
    @app.callback(
        Output("tabla-investigacion", "data"),
        Output("tarjetas-contexto-investigacion", "children"),
        ...
        dash.State("tabla-investigacion", "data"),
    )
    def datos_y_tarjetas_investigacion(
        ...
        if disparador == "tabla-investigacion" and data_tabla_actual:
            indicador_sel = None
            ...
            return dash.no_update, generar_tarjetas_contexto_investigacion(datos_ae, indicador_seleccionado=indicador_sel)
        ...
        if datos_ae.empty:
            ...
            return df_resultado.to_dict("records"), generar_tarjetas_contexto_investigacion(datos_ae)
        ...
        tarjetas_ui = generar_tarjetas_contexto_investigacion(datos_ae, indicador_seleccionado=indicador_seleccionado)
