...
def registrar_callback_impacto(app):
    ...
    # ==========================================================================
    # Callback de Alto Rendimiento (Tabla de Impacto)
    # ==========================================================================
    @app.callback(
    ...
    @app.callback(
        ...
        Output("tabla-impacto", "active_cell"),
        Output("store-numero-ind-modal-impacto", "data"),
        Output("alerta-doc-modal-impacto", "children"),
        Input("tabla-impacto", "active_cell"),
        Input("btn-cerrar-modal-impacto", "n_clicks"),
        Input("btn-entendido-modal-impacto", "n_clicks"),
        Input("seccion-actual", "data"),
        State("tabla-impacto", "data"),
    ...
    # ==========================================================================
    @app.callback(
        Output("download-modal-impacto", "data"),
        Output("alerta-doc-modal-impacto", "children", allow_duplicate=True),
        Input("btn-descargar-sgc-impacto", "n_clicks"),
        Input("btn-descargar-estrategico-impacto", "n_clicks"),
        State("store-numero-ind-modal-impacto", "data"),
        prevent_initial_call=True,
    )
    def descargar_documento_modal_impacto(n_sgc, n_estrategico, numero_ind):
        ...
        tipo = "SGC" if trigger == "btn-descargar-sgc-impacto" else "Estrategicos"
