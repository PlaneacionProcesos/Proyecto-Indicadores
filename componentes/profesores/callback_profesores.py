...
def registrar_callback_profersores(app):
    ...
    # ==========================================================================
    # Callback de Alto Rendimiento (Tabla de Profesores)
    # ==========================================================================
    @app.callback(
    ...
    # ==========================================================================
    # Callback para Controlar Apertura y Cierre del Modal de Profesores
    # ==========================================================================
    @app.callback(
        Output("modal-contexto-profesores", "style"),
        Output("modal-titulo-profesores", "children"),
        Output("modal-cuerpo-profesores", "children"),
        Output("tabla-profesores", "active_cell"),
        Output("store-numero-ind-modal-profesores", "data"),
        Output("alerta-doc-modal-profesores", "children"),
        Input("tabla-profesores", "active_cell"),
        Input("btn-cerrar-modal-profesores", "n_clicks"),
        Input("btn-entendido-modal-profesores", "n_clicks"),
        Input("seccion-actual", "data"),
        State("tabla-profesores", "data"),
        prevent_initial_call=True,
    )
    def controlar_modal_profesores(active_cell, n_close_x, n_close_btn, seccion_actual, data_tabla):
        if seccion_actual is not None and seccion_actual != "profesores":
        ...
        if ctx_id in ("btn-cerrar-modal-profesores", "btn-entendido-modal-profesores"):
            return {"display": "none"}, "", "", None, None, ""

        # Si el disparador fue la tabla y hay una celda seleccionada
        if ctx_id == "tabla-profesores" and active_cell is not None and data_tabla:
    ...
    # ==========================================================================
    @app.callback(
        Output("download-modal-profesores", "data"),
        Output("alerta-doc-modal-profesores", "children", allow_duplicate=True),
        Input("btn-descargar-sgc-profesores", "n_clicks"),
        Input("btn-descargar-estrategico-profesores", "n_clicks"),
        State("store-numero-ind-modal-profesores", "data"),
        prevent_initial_call=True,
    )
    def descargar_documento_modal_profesores(n_sgc, n_estrategico, numero_ind):
        ...
        tipo = "SGC" if trigger == "btn-descargar-sgc-profesores" else "Estrategicos"
