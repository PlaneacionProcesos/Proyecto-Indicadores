...
def registrar_callback_estudiantes(app):
    ...
    # ==========================================================================
    # Callback de Alto Rendimiento (Tabla de Estudiantes)
    # ==========================================================================
    @app.callback(
    ...
    @app.callback(
        ...
        Output("tabla-estudiantes", "active_cell"),
        Output("store-numero-ind-modal-estudiantes", "data"),
        Output("alerta-doc-modal-estudiantes", "children"),
    ...
    # ==========================================================================
    @app.callback(
        Output("download-modal-estudiantes", "data"),
        Output("alerta-doc-modal-estudiantes", "children", allow_duplicate=True),
        Input("btn-descargar-sgc-estudiantes", "n_clicks"),
        Input("btn-descargar-estrategico-estudiantes", "n_clicks"),
        State("store-numero-ind-modal-estudiantes", "data"),
        prevent_initial_call=True,
    )
    def descargar_documento_modal_estudiantes(n_sgc, n_estrategico, numero_ind):
        ...
        tipo = "SGC" if trigger == "btn-descargar-sgc-estudiantes" else "Estrategicos"
