...
COLORES_CABECERA = {
    "nombre_indicador": {"fondo": "#002060", "texto": "#FFFFFF"},
    "año-2023": {"fondo": "#6ED8D8", "texto": "#FFFFFF"},
    "año-2024": {"fondo": "#D86ECC", "texto": "#FFFFFF"},
    "año-2025": {"fondo": "#FFC000", "texto": "#FFFFFF"},
    "año-2026": {"fondo": "#47D45A", "texto": "#FFFFFF"},
    "variacion-ultimos_dos": {"fondo": "#002060", "texto": "#FFFFFF"},
    "porcentaje_variacion": {"fondo": "#002060", "texto": "#FFFFFF"},
}


def crear_tabla_seccion(seccion_id: str):
    """
    Genera un DataTable configurado para la sección indicada.
    Reemplaza la duplicación de los 7 archivos tabla_*.py.
    """
    ...
    return dash_table.DataTable(
        id=f"tabla-{seccion_id}",
        columns=[
            {"name": "Indicador", "id": "nombre_indicador"},
            {"name": "2023", "id": "año-2023"},
            {"name": "2024", "id": "año-2024"},
            {"name": "2025", "id": "año-2025"},
            {"name": "2026", "id": "año-2026"},
